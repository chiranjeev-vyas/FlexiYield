/**
 * FlexiYield Constants - TESTNET MODE
 * 
...
export const APP_MODE = IS_TESTNET ? "TESTNET" : "MAINNET";
 ...
 */
export function getAavePoolAddress(chainId: SupportedChainId): `0x${string}` {
 ...
 */
export function getChainMetadata(chainId: SupportedChainId) {
...
export function getTxExplorerUrl(
  ...
  return `${CHAIN_METADATA[chainId].explorer}/tx/${txHash}`;
}
...
export function getAddressExplorerUrl(
  ...
  return `${CHAIN_METADATA[chainId].explorer}/address/${address}`;
}
